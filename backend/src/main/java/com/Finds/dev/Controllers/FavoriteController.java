...
public class FavoriteController {
    ...
    public ResponseEntity<?> checkFavorite(@PathVariable String productId) {
        String userId = userService.getCurrentUserId();
        boolean isFavorite = favoriteRepository.findByUserIdAndProductId(userId, productId).isPresent();
    ...
    public ResponseEntity<?> deleteFavorite(@PathVariable String favoriteId) {
        // favoriteId is actually the Favorite record ID, not product ID
